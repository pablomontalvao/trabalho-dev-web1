...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom p-2">
      <div class="container-fluid">
        <a class="navbar-brand" href="#">
          <img src="../imagem/logobranca.png" alt="Logo da Empresa" class="logo-img">
        </a>
  ...
  <main>
    <div class="container mt-5 containerPaiForm">
      ...
      <form>
        ...
        <div class="d-grid gap-2 col-8 mx-auto mt-4">
          <a href="areaCliente.php" class="btn btn-primary" role="button">Entrar como Cliente</a>
          <a href="areaAdm.php" class="btn btn-secondary" role="button">Entrar como Administrador</a>
        </div>
      </form>
      <h3 class="mt-4 text-center">Não tem uma conta? <u><a href="cadastropage.php">Cadastre-se.</a></u></h3>
    </div>
  </main>
